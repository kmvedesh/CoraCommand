...
WebUI.click(findTestObject('Object Repository/Page_Home/Insights/reports'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Home/Insights/ReportsModule/dailyExecutionSummaryReport'), 
    0)
