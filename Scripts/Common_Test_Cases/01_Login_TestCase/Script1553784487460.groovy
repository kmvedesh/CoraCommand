...
try {
    ...
    WebUI.waitForElementNotVisible(findTestObject('Page_Login/div_SIGN IN_cora-canvas'), GlobalVariable.Max_Delay, FailureHandling.STOP_ON_FAILURE)

    WebUI.verifyElementPresent(findTestObject('Page_Home/a_Dashboard'), 0)
}
catch (Exception e) {
    WebUI.closeBrowser()
} 
