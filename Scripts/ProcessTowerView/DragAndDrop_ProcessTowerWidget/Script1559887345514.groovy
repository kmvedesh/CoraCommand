...
//WebUI.doubleClick(findTestObject('ProcessTowerView/ProcessTowerview_Widget'), FailureHandling.STOP_ON_FAILURE)
WebUI.verifyElementPresent(findTestObject('Object Repository/ProcessTowerView/text_processtowerview'), GlobalVariable.Min_Delay)

WebUI.comment('ProcessTowerView displayed')
