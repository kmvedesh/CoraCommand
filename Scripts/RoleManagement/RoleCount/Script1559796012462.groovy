...
WebUI.waitForElementPresent(findTestObject('Object Repository/Role_Management/role_count'), GlobalVariable.Max_Delay)

WebUI.delay(3)

rolecount = WebUI.getText(findTestObject('Object Repository/Role_Management/role_count'))

String RoleCount = new String()
